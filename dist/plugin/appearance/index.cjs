...
})(exports.Appearances || (exports.Appearances = {}));
exports.PREFERS_COLOR_SCHEME_MEDIA_QUERY_LIST = void 0;
if (typeof globalThis.matchMedia !== 'undefined')
    exports.PREFERS_COLOR_SCHEME_MEDIA_QUERY_LIST = globalThis.matchMedia('(prefers-color-scheme: dark)');
else
    exports.PREFERS_COLOR_SCHEME_MEDIA_QUERY_LIST = FALLBACK_MEDIA_QUERY_LIST;
...
var Appearance = {
    ...
    Constants: {
        Appearances: exports.Appearances
    },
    Errors: {}
};
function getAppearanceFromEngine() {
    ...
    if (CONTEXT === null)
        return exports.Appearances.Light;
    CONTEXT.drawImage(img, 0, 0);
    var data = CONTEXT.getImageData(0, 0, 1, 1).data;
    if ((data[0] & data[1] & data[2]) < 255)
        return exports.Appearances.Dark;
    else
        return exports.Appearances.Light;
}
function getAppearanceFromMediaQuery() {
    if (exports.PREFERS_COLOR_SCHEME_MEDIA_QUERY_LIST.media === 'not all')
        return exports.Appearances.Unknown;
    if (exports.PREFERS_COLOR_SCHEME_MEDIA_QUERY_LIST.matches)
        return exports.Appearances.Dark;
    return exports.Appearances.Light;
}
...
function attachOnChange() {
    ...
    EventListener.add(exports.PREFERS_COLOR_SCHEME_MEDIA_QUERY_LIST, { type: 'change', callback: onMediaChange });
    if (Platform.browser.name === Browsers.SamsungInternet)
        startPolling();
}
function detachOnChange() {
    appearanceRef = null;
    EventListener.remove(exports.PREFERS_COLOR_SCHEME_MEDIA_QUERY_LIST, { type: 'change', callback: onMediaChange });
    if (Platform.browser.name === Browsers.SamsungInternet)
        stopPolling();
}
function onMediaChange(event) {
    var appearance;
    if (event.matches)
        appearance = exports.Appearances.Dark;
    else
        appearance = exports.Appearances.Light;
    if (appearance !== appearanceRef)
        onChangeSubscriptionManager.emit(appearanceRef = appearance);
}

exports.CONTEXT = CONTEXT;
exports.SVG_PIXEL_DATA_URL = SVG_PIXEL_DATA_URL;
