...
if (typeof globalThis.matchMedia !== 'undefined')
    exports.MEDIA_QUERY_LIST = globalThis.matchMedia('(prefers-color-scheme: dark)');
else
...
function getAppearanceFromMediaQuery() {
    ...
    if (exports.MEDIA_QUERY_LIST.matches)
        return exports.Appearances.Dark;
    return exports.Appearances.Light;
}
...
function attachOnChange() {
    ...
    EventListener.add(exports.MEDIA_QUERY_LIST, { type: 'change', callback: onMediaChange });
    if (Platform.browser.name === Browsers.SamsungInternet)
        startPolling();
}
function detachOnChange() {
    appearanceRef = null;
    EventListener.remove(exports.MEDIA_QUERY_LIST, { type: 'change', callback: onMediaChange });
    if (Platform.browser.name === Browsers.SamsungInternet)
        stopPolling();
}
