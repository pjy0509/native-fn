...
(function (Engines) {
    ...
    Engines["Gecko"] = "Gecko";
})(exports.Engines || (exports.Engines = {}));
...
var OS_RESOLVER_MAP = [
    [/windows nt (6\.[23]); arm/i, exports.OS.Windows, resolveWindowsVersion],
    [/windows (?:phone|mobile|iot)(?: os)?[\/ ]?([\d.]*( se)?)/i, exports.OS.Windows, resolveWindowsVersion],
    [/windows[\/ ](1[01]|2000|3\.1|7|8(\.1)?|9[58]|me|server 20\d\d( r2)?|vista|xp)/i, exports.OS.Windows, resolveWindowsVersion],
    [/windows nt ?([\d.)]*)(?!.+xbox)/i, exports.OS.Windows, resolveWindowsVersion],
    [/\bwin(?=3| ?9|n)(?:nt| 9x )?([\d.;]*)/i, exports.OS.Windows, resolveWindowsVersion],
    [/windows ce\/?([\d.]*)/i, exports.OS.Windows, resolveWindowsVersion],
    [/[adehimnop]{4,7}\b(?:.*os (\w+) like mac|; opera)/i, exports.OS.iOS, resolveUnderscoreVersion],
    [/(?:ios;fbsv|ios(?=.+ip(?:ad|hone))|ip(?:ad|hone)(?: |.+i(?:pad)?)os)[\/ ]([\w.]+)/i, exports.OS.iOS, resolveUnderscoreVersion],
    [/cfnetwork\/.+darwin/i, exports.OS.iOS, resolveUnderscoreVersion],
    [/mac os x ?([\w. ]*)/i, exports.OS.MacOS, resolveUnderscoreVersion],
    [/(?:macintosh|mac_powerpc\b)(?!.+(haiku|morphos))/i, exports.OS.MacOS, resolveUnderscoreVersion],
    [/droid ([\w.]+)\b.+(android[- ]x86)/i, exports.OS.Android],
    [/android\w*[-\/.; ]?([\d.]*)/i, exports.OS.Android],
];
var ENGINE_RESOLVER_MAP = [
    [/windows.+ edge\/([\w.]+)/i, exports.Engines.EdgeHTML],
    [/arkweb\/([\w.]+)/i, exports.Engines.ArkWeb],
    [/webkit\/537\.36.+chrome\/(?!27)([\w.]+)/i, exports.Engines.Blink],
    [/presto\/([\w.]+)/i, exports.Engines.Presto],
    [/webkit\/([\w.]+)/i, exports.Engines.WebKit],
    [/trident\/([\w.]+)/i, exports.Engines.Trident],
    [/netfront\/([\w.]+)/i, exports.Engines.NetFront],
    [/khtml[\/ ]\(?([\w.]+)/i, exports.Engines.KHTML],
    [/tasman[\/ ]\(?([\w.]+)/i, exports.Engines.Tasman],
    [/rv:([\w.]{1,9})\b.+gecko/i, exports.Engines.Gecko]
];
var BROWSER_RESOLVER_MAP = [
    [/\b(?:crmo|crios)\/([\w.]+)/i, exports.Browsers.Chrome],
    [/webview.+edge\/([\w.]+)/i, exports.Browsers.Edge],
    [/edg(?:e|ios|a)?\/([\w.]+)/i, exports.Browsers.Edge],
    [/opera mini\/([-\w.]+)/i, exports.Browsers.Opera],
    [/opera [mobileta]{3,6}\b.+version\/([-\w.]+)/i, exports.Browsers.Opera],
    [/opera(?:.+version\/|[\/ ]+)([\w.]+)/i, exports.Browsers.Opera],
    [/opios[\/ ]+([\w.]+)/i, exports.Browsers.Opera],
    [/\bop(?:rg)?x\/([\w.]+)/i, exports.Browsers.Opera],
    [/\bopr\/([\w.]+)/i, exports.Browsers.Opera],
    [/iemobile(?:browser|boat|jet)[\/ ]?([\d.]*)/i, exports.Browsers.IE],
    [/(?:ms|\()ie ([\w.]+)/i, exports.Browsers.IE],
    [/trident.+rv[: ]([\w.]{1,9})\b.+like gecko/i, exports.Browsers.IE],
    [/\bfocus\/([\w.]+)/i, exports.Browsers.Firefox],
    [/\bopt\/([\w.]+)/i, exports.Browsers.Opera],
    [/coast\/([\w.]+)/i, exports.Browsers.Opera],
    [/fxios\/([\w.-]+)/i, exports.Browsers.Firefox],
    [/samsungbrowser\/([\w.]+)/i, exports.Browsers.SamsungInternet],
    [/headlesschrome(?:\/([\w.]+)| )/i, exports.Browsers.Chrome],
    [/wv\).+chrome\/([\w.]+).+edgw\//i, exports.Browsers.Edge],
    [/ wv\).+(chrome)\/([\w.]+)/i, exports.Browsers.Chrome],
    [/chrome\/([\w.]+) mobile/i, exports.Browsers.Chrome],
    [/chrome\/v?([\w.]+)/i, exports.Browsers.Chrome],
    [/version\/([\w.,]+) .*mobile(?:\/\w+ | ?)safari/i, exports.Browsers.Safari],
    [/iphone .*mobile(?:\/\w+ | ?)safari/i, exports.Browsers.Safari],
    [/version\/([\w.,]+) .*safari/i, exports.Browsers.Safari],
    [/webkit.+?(?:mobile ?safari|safari)(\/[\w.]+)/i, exports.Browsers.Safari, '1'],
    [/(?:mobile|tablet);.*firefox\/([\w.-]+)/i, exports.Browsers.Firefox],
    [/mobile vr; rv:([\w.]+)\).+firefox/i, exports.Browsers.Firefox],
    [/firefox\/([\w.]+)/i, exports.Browsers.Firefox],
];
...
function getDevice() {
    ...
    if (osName === exports.OS.iOS || osName === exports.OS.Android)
        return exports.Devices.Mobile;
    if (osName === exports.OS.Windows || osName === exports.OS.MacOS)
        return exports.Devices.Desktop;
    return exports.Devices.Unknown;
}
...
exports.BROWSER_RESOLVER_MAP = BROWSER_RESOLVER_MAP;
exports.ENGINE_RESOLVER_MAP = ENGINE_RESOLVER_MAP;
