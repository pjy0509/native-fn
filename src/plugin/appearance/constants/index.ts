...
export let PREFERS_COLOR_SCHEME_MEDIA_QUERY_LIST: MediaQueryList;

if (typeof globalThis.matchMedia !== 'undefined') PREFERS_COLOR_SCHEME_MEDIA_QUERY_LIST = globalThis.matchMedia('(prefers-color-scheme: dark)');
else PREFERS_COLOR_SCHEME_MEDIA_QUERY_LIST = FALLBACK_MEDIA_QUERY_LIST;
